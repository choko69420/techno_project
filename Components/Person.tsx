    ...
    <>
      <div className="text-center">
        ...
        <div className="container my-32 mx-auto ">
          <div className="my-50 hover:max-h-120 relative max-h-60 overflow-hidden rounded-2xl bg-sky-500 p-8 align-middle shadow-xl transition duration-700 ease-in hover:overflow-visible hover:bg-blue-600">
            ...
            <div className="max-w-md overflow-auto break-words text-left">
              <p className=" ">
                ...
                ornare feugiat erat. Praesent at orci lobortis, aliquam leo id,
                iaculis nibh. Curabitur ut pretium purus. Phasellus ut mi id
                arcu fermentum porta. Maecenas pharetra, tortor sit amet
                malesuada mattis, nisl erat facilisis augue, ac convallis arcu
                orci et neque. Pellentesque dapibus luctus arcu nec dignissim.
                Etiam a iaculis mauris. Maecenas tincidunt est justo, sed congue
                orci posuere suscipit. In in sem nisi. Fusce id volutpat est, eu
                venenatis mauris. In hac habitasse platea dictumst. Proin ut leo
                eu dui tempus dignissim tempus quis quam. Nulla tempor mollis
                metus in rutrum. Mauris vitae est ut sem accumsan tempus non ac
                tellus. Ut pretium tristique eros sit amet laoreet. Aenean eget
                pharetra est. Aliquam ut sem sed velit laoreet volutpat ut
              </p>
            </div>
          </div>
        </div>
